                ...
                <Container sx={{ p: [4, 6, 9] }}>
                    <Grid container justifyContent="center" alignItems="center" spacing={3}>
                        <Grid item xs={12} md={6} mb={4} className='mt-5'>
                            <Typography data-aos="fade-left" variant="h2" sx={{ textAlign: 'center', fontWeight: '500' }}>
                                Welcome,
                            </Typography>
                            <Typography className='mt-2' data-aos="fade-left" variant="body1" component="div" sx={{ width: '100%', textAlign: 'center' }}>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            } sx={{ maxWidth: '100%', justifyContent: 'center', textAlign: 'center', marginBottom: ['-2em', '-3em', '-5em'] }}>
                                <CardMedia
                                    data-aos="zoom-in-up"
                                    className='trainImg'
                                    component="img"
                                    ...
                                    height="100"
                                    image={homeTrain}
                                    style={{ maxWidth: '100%', height: 'auto', borderBottomLeftRadius: "25%", borderTopRightRadius: "25%" }}
                                />
                            </Card>
                        </Grid>
                    </Grid>
